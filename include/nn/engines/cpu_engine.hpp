...
class CPUEngineHandle : public IEngineHandle {
public:
  CPUEngineHandle(stream s)
      : stream_(s) {}

  ~CPUEngineHandle() override = default;
...
public:
  ...
  void legacy_dense_fwd(engine_handle backend_handle, const void* input, const void* weight,
                        void* output, size_t batch_size, size_t in_features, size_t out_features,
                        DTypeDesc type_desc) override;

  void legacy_dense_wgrad(engine_handle backend_handle, const void* input, const void* grad_output,
                          void* grad_weight, size_t batch_size, size_t in_features,
                          size_t out_features, DTypeDesc type_desc) override;

  void legacy_dense_dgrad(engine_handle backend_handle, const void* grad_output, const void* weight,
                          void* grad_input, size_t batch_size, size_t in_features,
                          size_t out_features, DTypeDesc type_desc) override;

  void legacy_dense_bgrad(engine_handle backend_handle, const void* grad_output, void* grad_bias,
                          size_t batch_size, size_t out_features, DTypeDesc type_desc) override;

  void legacy_dense_add_bias(engine_handle backend_handle, void* output, const void* bias,
                             size_t batch_size, size_t out_features, DTypeDesc type_desc) override;

  void legacy_avgpool2d_fwd(engine_handle backend_handle, const void* input, void* output,
  ...
  void legacy_avgpool2d_bwd(engine_handle backend_handle, const void* grad_output, void* grad_input,
                            size_t batch_size, size_t channels, size_t input_h, size_t input_w,
                            size_t output_h, size_t output_w, size_t pool_h, size_t pool_w,
                            size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w,
                            DTypeDesc type_desc) override;

  void legacy_maxpool2d_fwd(engine_handle backend_handle, const void* input, void* output,
                            size_t batch_size, size_t channels, size_t input_h, size_t input_w,
                            size_t output_h, size_t output_w, size_t pool_h, size_t pool_w,
                            size_t stride_h, size_t stride_w, size_t pad_h, size_t pad_w,
                            void* mask_indices, DTypeDesc type_desc) override;

  void legacy_maxpool2d_bwd(engine_handle backend_handle, const void* grad_output, void* grad_input,
                            size_t batch_size, size_t channels, size_t output_h, size_t output_w,
                            const void* mask_indices, DTypeDesc type_desc) override;

  void legacy_batchnorm_fwd(engine_handle backend_handle, const void* input, void* batch_mean,
  ...
  void legacy_batchnorm_infer(engine_handle backend_handle, const void* input,
                              const void* running_mean, const void* running_var, const void* gamma,
                              const void* beta, void* output, size_t batch_size, size_t channels,
                              size_t spatial_size, float epsilon, bool affine,
                              DTypeDesc type_desc) override;

  void legacy_batchnorm_bwd(engine_handle backend_handle, const void* grad_output,
                            const void* norm_input, const void* inv_std, const void* gamma,
                            void* d_gamma, void* d_beta, void* grad_input, size_t batch_size,
                            size_t channels, size_t spatial_size, bool affine,
                            DTypeDesc type_desc) override;

  void legacy_conv2d_fwd(engine_handle backend_handle, const void* col_data,
                         const void* weight_data, void* output_data, size_t output_size,
                         size_t kernel_size, size_t out_channels, DTypeDesc type_desc) override;

  void legacy_conv2d_wgrad(engine_handle backend_handle, const void* col_data,
                           const void* gradient_data, void* grad_weight_data, size_t output_size,
                           size_t kernel_size, size_t out_channels, DTypeDesc type_desc) override;

  void legacy_conv2d_dgrad(engine_handle backend_handle, const void* gradient_data,
                           const void* weight_data, void* col_grad_data, size_t output_size,
                           size_t kernel_size, size_t out_channels, DTypeDesc type_desc) override;

  void legacy_conv2d_bgrad(engine_handle backend_handle, const void* gradient_data,
                           void* grad_bias_data, size_t batch_size, size_t output_h,
                           size_t output_w, size_t out_channels, DTypeDesc type_desc) override;

  void legacy_conv2d_add_bias(engine_handle backend_handle, void* output_data,

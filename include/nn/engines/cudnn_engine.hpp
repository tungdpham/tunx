...
class CuDNNEngineHandle : public IEngineHandle {
public:
  CuDNNEngineHandle(stream s)
      : stream_(s) {
    cudnnCreate(&cudnn_handle_);
    cudnnSetStream(cudnn_handle_, *s.as<cuda_stream>());
  }

  ~CuDNNEngineHandle() override {
  ...
  cudnnHandle_t handle() { return cudnn_handle_; }

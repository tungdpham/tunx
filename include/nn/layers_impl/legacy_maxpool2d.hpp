...
class LegacyMaxPool2D : public FunctionalLayer<LegacyMaxPool2DOp> {
public:
  LegacyMaxPool2D(size_t pool_h, size_t pool_w, size_t stride_h = 0, size_t stride_w = 0,
      ...
      : FunctionalLayer(
            LegacyMaxPool2DOp::Config{pool_h, pool_w, stride_h == 0 ? pool_h : stride_h,

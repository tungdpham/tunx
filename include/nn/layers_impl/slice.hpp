...
class Slice : public FunctionalLayer<SliceOp> {
public:
  Slice(int axis, size_t start, size_t length, const std::string &name = "slice")
      : FunctionalLayer(SliceOp::Config{axis, start, length}, name) {}
};
}  // namespace tunx

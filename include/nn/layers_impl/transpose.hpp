...
class Transpose : public FunctionalLayer<TransposeOp> {
public:
  Transpose(size_t dim0, size_t dim1, const std::string &name = "transpose")
      : FunctionalLayer(TransposeOp::Config{dim0, dim1}, name) {}
};
}  // namespace tunx

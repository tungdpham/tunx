...
namespace tunx {
namespace kernel {
inline void copy(const dptr src, dptr dst, size_t size, stream s = nullptr) {
...
inline void bswap(DType_t dtype, const dptr input, dptr output, size_t size, stream s = nullptr) {

...
inline void add(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
...
inline void sub(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void mul(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void div(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void fmadd(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void fmsub(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void fnmadd(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
// Scalar Operations
inline void add_scalar(DType_t dtype, const void *a_ptr, double scalar, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void sub_scalar(DType_t dtype, const void *a_ptr, double scalar, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void mul_scalar(DType_t dtype, const void *a_ptr, double scalar, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void div_scalar(DType_t dtype, const void *a_ptr, double scalar, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void axpy(DType_t dtype, double alpha, const void *x_ptr, void *y_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
...
inline void sqrt(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void abs(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void rsqrt(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void rcp(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void min(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void max(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void scalar_max(DType_t dtype, const void *a_ptr, double scalar, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void clamp(DType_t dtype, const void *a_ptr, double min_val, double max_val, void *c_ptr,
                  size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void equal(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void greater(DType_t dtype, const void *a_ptr, const void *b_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
    T *c = static_cast<T *>(c_ptr);
...
// Memory Operations
inline void copy(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void zero(DType_t dtype, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    T *c = static_cast<T *>(c_ptr);
...
inline void sub_mul_scalar(DType_t dtype, const void *a_ptr, double sub_scalar, double mul_scalar,
...
inline void mul_add_scalar(DType_t dtype, const void *a_ptr, double mul_scalar, double add_scalar,
                           void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
// Reduction Functions
inline double sum(DType_t dtype, const void *a_ptr, size_t size) {
  double _ret = 0;
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
...
inline double dot_product(DType_t dtype, const void *a_ptr, const void *b_ptr, size_t size) {
  double _ret = 0;
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);
...
inline double sum_squared_diff(DType_t dtype, const void *a_ptr, double mean, size_t size) {
  double _ret = 0;
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
...
inline double norm_squared(DType_t dtype, const void *a_ptr, size_t size) {
  double _ret = 0;
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
...
inline void cast(DType_t a_dtype, DType_t b_dtype, const void *a_ptr, void *b_ptr, size_t size) {
...
inline void bswap(DType_t dtype, const void *a_ptr, void *c_ptr, size_t size) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    T *c = static_cast<T *>(c_ptr);
...
inline void check_equals(DType_t dtype, const void *a_ptr, const void *b_ptr, size_t size,
                         bool &result, double eps) {
  auto func = [&]<typename T>(T type_dummy) {
    const T *a = static_cast<const T *>(a_ptr);
    const T *b = static_cast<const T *>(b_ptr);

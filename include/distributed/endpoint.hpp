...
// Hash function specialization for tunx::Endpoint
namespace std {
template <>
struct hash<tunx::Endpoint> {
  size_t operator()(const tunx::Endpoint &endpoint) const noexcept { return endpoint.hash(); }
};
}  // namespace std
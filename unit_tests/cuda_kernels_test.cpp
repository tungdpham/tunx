...
TEST_F(CudaKernelsTest, AddTest) {
  ...
  ops::cuda::cuda_add(dev_a, dev_b, dev_c, size, 0);
...
TEST_F(CudaKernelsTest, SubTest) {
  ...
  ops::cuda::cuda_sub(dev_a, dev_b, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, MulTest) {
  ...
  ops::cuda::cuda_mul(dev_a, dev_b, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, DivTest) {
  ...
  ops::cuda::cuda_div(dev_a, dev_b, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, AddScalarTest) {
  ...
  ops::cuda::cuda_add_scalar(dev_a, scalar, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, SqrtTest) {
  ...
  ops::cuda::cuda_sqrt(dev_a, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, MaxTest) {
  ...
  ops::cuda::cuda_max(dev_a, dev_b, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}
...
TEST_F(CudaKernelsTest, SumReductionTest) {
  ...
  float result = ops::cuda::cuda_sum(dev_a, size, 0);
...
TEST_F(CudaKernelsTest, DotProductTest) {
  ...
  float result = ops::cuda::cuda_dot_product(dev_a, dev_b, size, 0);
...
TEST_F(CudaKernelsTest, BatchNormOperationsTest) {
  ...
  ops::cuda::cuda_sub_mul_scalar(dev_a, sub_scalar, mul_scalar, dev_c, size, 0);
  CompareCudaWithCPU(host_expected);
}

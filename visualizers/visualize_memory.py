...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Visualize memory placement from CSV.')
    parser.add_argument('csv_file', nargs='?', type=str, default='build/memory_placement.csv', help='Path to the CSV file (default: memory_placement.csv)')
    parser.add_argument('--offset', type=str, default='ffd_offset', choices=['naive_offset', 'ffd_offset'], help='Offset column to use (default: ffd_offset)')
    parser.add_argument('--out', type=str, default='memory_placement.png', help='Output image file (default: memory_placement.png)')

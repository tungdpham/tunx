...
Sequential create_mnist_cnn(DType_t io_dtype_ = DType_t::FP32) {
  auto layers = LayerBuilder({{28, 28, 1}})
                    ...
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn2_1x1")
...
Sequential create_cifar10_vgg(DType_t io_dtype_ = DType_t::FP32) {
  auto layers = LayerBuilder({{32, 32, 3}})
                    ...
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn6")
                    .maxpool2d(2, 2, 2, 2, 0, 0, "pool2")
                    .conv2d(512, 3, 3, 1, 1, 1, 1, false, "conv7")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn7")
                    .conv2d(512, 3, 3, 1, 1, 1, 1, false, "conv8")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn8")
                    .conv2d(512, 3, 3, 1, 1, 1, 1, false, "conv9")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn9")
...
Sequential create_cifar10_test(DType_t io_dtype_ = DType_t::FP32) {
  auto layers = LayerBuilder({{32, 32, 3}})
                    .dtype(io_dtype_)
                    // LayerImpl 1: 3 -> 64 -> 128 channels, 32x32 -> 16x16
                    .conv2d(64, 3, 3, 1, 1, 1, 1, false, "conv1")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn1")
                    .conv2d(128, 3, 3, 1, 1, 1, 1, false, "conv2")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn2")
...
Sequential create_cifar100_wrn16_8(DType_t io_dtype_ = DType_t::FP32) {
  ...
  auto layers = LayerBuilder({{32, 32, 3}})
                    ...
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn_final")
...
Sequential create_tiny_imagenet_resnet18(DType_t io_dtype_ = DType_t::FP32) {
  auto layers = LayerBuilder({{64, 64, 3}})
                    .dtype(io_dtype_)
                    .conv2d(32, 3, 3, 1, 1, 1, 1, false, "conv1")
                    .batchnorm(dtype_eps(io_dtype_), 0.1f, true, SBool::TRUE, "bn1")
                    .maxpool2d(2, 2, 2, 2, 0, 0, "maxpool")
...
Sequential create_tiny_imagenet_resnet50(DType_t io_dtype_ = DType_t::FP32) {
  auto layers = LayerBuilder({{64, 64, 3}})
                    ...
                    // LayerImpl 1: 64 channels, 3 bottleneck blocks
                    ...
                    // LayerImpl 2: 128 channels, 4 bottleneck blocks with stride 2
                    ...
                    // LayerImpl 3: 256 channels, 6 bottleneck blocks with stride 2
                    ...
                    // LayerImpl 4: 512 channels, 3 bottleneck blocks with stride 2
